...
def update_version():
    with open(f"{os.path.dirname(__file__)}/spare-blockchain-gui/package.json") as f:
        data = json.load(f)
    ...
    with open(f"{os.path.dirname(__file__)}/spare-blockchain-gui/package.json", "w") as w:
