"""
NOTE: This contains duplicate code from `replaceme.cmds.plots`.
After `replaceme plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Replaceme Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_replaceme(args, root_path):
