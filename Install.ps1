...
venv\scripts\pip install --extra-index-url https://pypi.replaceme.net/simple/ miniupnpc==2.2.2
venv\scripts\pip install --editable . --extra-index-url https://pypi.replaceme.net/simple/
