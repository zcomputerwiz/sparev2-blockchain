"""
NOTE: This contains duplicate code from `spare.cmds.plots`.
After `spare plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Spare Proof of Space", "version": chiapos_version, "installed": True}
