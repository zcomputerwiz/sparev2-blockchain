...
from spare.plotting.create_plots import resolve_plot_keys
from spare.plotters.plotters_util import run_plotter, run_command
    ...
    if is_madmax_supported():
        ...
        run_command(
            [
                "git",
                "clone",
                "https://github.com/Spare-Network/spare-plotter-madmax.git",
                MADMAX_PLOTTER_DIR,
            ],
