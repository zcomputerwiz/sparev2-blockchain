...
from replaceme.daemon.client import acquire_connection_to_daemon
from replaceme.util.keychain import Keychain, obtain_current_passphrase, supports_os_passphrase_storage
    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other Replaceme processes will be able to access your keys without prompting for your passphrase."
            )
...
def read_passphrase_from_file(passphrase_file: TextIOWrapper) -> str:
    passphrase = passphrase_file.read().rstrip(os.environ.get("REPLACEME_PASSPHRASE_STRIP_TRAILING_CHARS", "\r\n"))
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'replaceme passphrase set' or 'replaceme passphrase remove' to update or remove your passphrase")
        sys.exit(1)
