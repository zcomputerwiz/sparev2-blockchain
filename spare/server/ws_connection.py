...
from spare.cmds.init_funcs import spare_full_version_str
from spare.protocols.protocol_message_types import ProtocolMessageTypes
from spare.protocols.protocol_state_machine import message_response_ok
from spare.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from spare.protocols.shared_protocol import Capability, Handshake
from spare.server.outbound_message import Message, NodeType, make_msg
from spare.server.rate_limits import RateLimiter
from spare.types.blockchain_format.sized_bytes import bytes32
from spare.types.peer_info import PeerInfo
from spare.util.errors import Err, ProtocolError
from spare.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from spare.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSSpareConnection:
    """
