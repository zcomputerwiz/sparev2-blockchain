...
from spare.util.misc import prompt_yes_no
...
def check_legacy_keyring_keys_present(keyring: Union[MacKeyring, WinKeyring]) -> bool:
    ...
    from spare.util.keychain import default_keychain_user, default_keychain_service, get_private_key_user, MAX_KEYS
...
class KeyringWrapper:
    ...
    def _get_initial_cached_passphrase(self) -> str:
        ...
        """
        from spare.util.keychain import supports_os_passphrase_storage
    ...
    def confirm_migration(self) -> bool:
        ...
        if master_passphrase == DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE:
            ...
            if response:
                from spare.cmds.passphrase_funcs import prompt_for_new_passphrase
    ...
    def migrate_legacy_keys(self) -> MigrationResults:
        from spare.util.keychain import get_private_key_user, Keychain, MAX_KEYS
    ...
    def migrate_legacy_keyring_interactive(self):
        ...
        """
        from spare.cmds.passphrase_funcs import async_update_daemon_migration_completed_if_running
