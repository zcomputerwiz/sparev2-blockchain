from spare.protocols.protocol_message_types import ProtocolMessageTypes as pmt, ProtocolMessageTypes
...
VAILD_REPLY_MESSAGE_MAP = {
    ...
    # pmt.handshake is handled in WSSpareConnection.perform_handshake
