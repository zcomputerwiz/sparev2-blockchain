...
from spare.daemon.keychain_proxy import connect_to_keychain_and_validate, wrap_local_keychain
...
from spare.full_node.generator import setup_generator_args
from spare.full_node.mempool_check_conditions import GENERATOR_MOD
from spare.plotting.create_plots import create_plots, PlotKeys
...
from spare.consensus.coinbase import create_puzzlehash_for_pk, create_farmer_coin, create_pool_coin
...
from spare.plotting.util import PlotsRefreshParameter, PlotRefreshResult, PlotRefreshEvents, parse_plot_info
from spare.plotting.manager import PlotManager
...
from spare.types.blockchain_format.foliage import Foliage, FoliageBlockData, FoliageTransactionBlock, TransactionsInfo
from spare.types.blockchain_format.pool_target import PoolTarget
from spare.types.blockchain_format.program import INFINITE_COST
from spare.types.blockchain_format.proof_of_space import ProofOfSpace
from spare.types.blockchain_format.reward_chain_block import RewardChainBlockUnfinished
...
from spare.util.ints import uint8, uint16, uint32, uint64, uint128
from spare.util.keychain import Keychain, bytes_to_mnemonic
from spare.util.merkle_set import MerkleSet
from spare.util.prev_transaction_block import get_prev_transaction_block
    ...
    async def setup_keys(self):
        if self.local_keychain:
            ...
            self.keychain_proxy = await connect_to_keychain_and_validate(
                self.root_path, log, user="testing-1.8.0", service="spare-testing-1.8.0"
            )
