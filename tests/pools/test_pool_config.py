...
from replaceme.pools.pool_config import PoolWalletConfig
from replaceme.util.config import load_config, save_config, create_default_replaceme_config
...
def test_pool_config():
    ...
    create_default_replaceme_config(test_root, ["config.yaml"])
