...
import {
  ...
  Fee,
  Form,
  TextField as replacemeTextField,
  AlertDialog,
  CopyToClipboard,
  Flex,
  Card,
...
import { /* mojo_to_replaceme_string, */ replaceme_to_mojo } from '../../../util/replaceme';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_replaceme_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of replaceme in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of replaceme that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and replaceme that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send replaceme to coloured address. Please enter a replaceme
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'replaceme_addr://') {
    ...
    const amountValue = Number.parseFloat(replaceme_to_mojo(amount));
    const feeValue = Number.parseFloat(replaceme_to_mojo(fee));
