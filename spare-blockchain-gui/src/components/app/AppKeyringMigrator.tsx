...
import { AlertDialog, ConfirmDialog } from '@replaceme/core';
        ...
        <DialogContent>
          ...
          {keyring_state.can_save_passphrase && (
            <Box display="flex" alignItems="center">
              ...
              />
              <Tooltip title={t`Your passphrase can be stored in your system's secure credential store. replaceme will be able to access your keys without prompting for your passphrase.`}>
