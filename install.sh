...
python -m pip install --extra-index-url https://pypi.replaceme.net/simple/ miniupnpc==2.2.2
python -m pip install -e . --extra-index-url https://pypi.replaceme.net/simple/
